...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TaskQuest.DoesMapShowTaskQuestObjectives)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TaskQuest.GetQuestLocation)
---@param questID number
---@param uiMapID number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TaskQuest.GetQuestProgressBarInfo)
---@param questID number
---@return number progress
function C_TaskQuest.GetQuestProgressBarInfo(questID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TaskQuest.GetQuestTimeLeftMinutes)
---@param questID number
---@return number minutesLeft
function C_TaskQuest.GetQuestTimeLeftMinutes(questID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_TaskQuest.GetQuestTimeLeftSeconds)
---@param questID number
