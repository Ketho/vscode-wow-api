...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetCurrentAffixes)
---@return MythicPlusKeystoneAffix[] affixIDs
function C_MythicPlus.GetCurrentAffixes() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetCurrentSeason)
---@return number seasonID
function C_MythicPlus.GetCurrentSeason() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetCurrentSeasonValues)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetCurrentUIDisplaySeason)
---@return number? seasonID
function C_MythicPlus.GetCurrentUIDisplaySeason() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetEndOfRunGearSequenceLevel)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetLastWeeklyBestInformation)
---@return number challengeMapId
---@return number level
function C_MythicPlus.GetLastWeeklyBestInformation() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetOwnedKeystoneChallengeMapID)
---@return number challengeMapID
function C_MythicPlus.GetOwnedKeystoneChallengeMapID() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetOwnedKeystoneLevel)
---@return number keyStoneLevel
function C_MythicPlus.GetOwnedKeystoneLevel() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetOwnedKeystoneMapID)
---@return number mapID
function C_MythicPlus.GetOwnedKeystoneMapID() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetRewardLevelForDifficultyLevel)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetRewardLevelFromKeystoneLevel)
---@param keystoneLevel number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetSeasonBestForMap)
---@param mapChallengeModeID number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetSeasonBestMythicRatingFromThisExpansion)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetWeeklyBestForMap)
---@param mapChallengeModeID number
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.GetWeeklyChestRewardLevel)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.IsMythicPlusActive)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.RequestMapInfo)
function C_MythicPlus.RequestMapInfo() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_MythicPlus.RequestRewards)
