...
function C_TradeSkillUI.GetCategoryInfo() end
...
function C_TradeSkillUI.OpenTradeSkill() end
...
function C_Transmog.CanTransmogItemWithItem() end
...
function C_Transmog.LoadOutfit() end
...
function C_TransmogCollection.GetIsAppearanceFavorite() end
...
function C_TransmogCollection.GetSourceRequiredHoliday() end
...
function C_TransmogCollection.IsCategoryValidForItem() end

---[Documentation](https://wow.gamepedia.com/API_C_TransmogCollection.IsNewAppearance)
function C_TransmogCollection.IsNewAppearance() end
...
function C_TransmogCollection.SetSourceTypeFilter() end

---[Documentation](https://wow.gamepedia.com/API_C_TransmogCollection.SetUncollectedShown)
function C_TransmogCollection.SetUncollectedShown() end
...
function C_TransmogSets.GetBaseSetID() end
...
function C_TransmogSets.GetSetInfo() end

---[Documentation](https://wow.gamepedia.com/API_C_TransmogSets.GetSetSources)
function C_TransmogSets.GetSetSources() end
...
function C_TransmogSets.GetVariantSets() end
...
function ClosestUnitPosition() end
...
function EJ_GetInvTypeSortOrder() end
...
function EJ_GetNumEncountersForLootByIndex() end
...
function FindBaseSpellByID() end
...
function FindSpellOverrideByID() end
