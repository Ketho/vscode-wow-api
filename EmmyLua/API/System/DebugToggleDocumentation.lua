...
---[Documentation](https://warcraft.wiki.gg/wiki/API_TogglePlayerBounds)
function TogglePlayerBounds() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_TogglePortals)
function TogglePortals() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_ToggleTris)
