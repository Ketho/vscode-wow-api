...
---[Documentation](https://wowpedia.fandom.com/wiki/API_C_QuestInfoSystem.GetQuestRewardSpellInfo)
---@param questID? number
---@param spellID number
---@return QuestRewardSpellInfo? info
function C_QuestInfoSystem.GetQuestRewardSpellInfo(questID, spellID) end

---[Documentation](https://wowpedia.fandom.com/wiki/API_C_QuestInfoSystem.GetQuestRewardSpells)
---@param questID? number
---@return number[] spellIDs
function C_QuestInfoSystem.GetQuestRewardSpells(questID) end

---[Documentation](https://wowpedia.fandom.com/wiki/API_C_QuestInfoSystem.GetQuestShouldToastCompletion)
---@param questID? number
---@return boolean shouldToast
function C_QuestInfoSystem.GetQuestShouldToastCompletion(questID) end

---[Documentation](https://wowpedia.fandom.com/wiki/API_C_QuestInfoSystem.HasQuestRewardSpells)
---@param questID? number
