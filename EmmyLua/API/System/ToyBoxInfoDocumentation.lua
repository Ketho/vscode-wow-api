...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_ToyBoxInfo.IsToySourceValid)
---@param source number
---@return boolean isToySourceValid
function C_ToyBoxInfo.IsToySourceValid(source) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_ToyBoxInfo.IsUsingDefaultFilters)
---@return boolean isUsingDefaultFilters
function C_ToyBoxInfo.IsUsingDefaultFilters() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_ToyBoxInfo.NeedsFanfare)
---@param itemID number
---@return boolean needsFanfare
function C_ToyBoxInfo.NeedsFanfare(itemID) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_ToyBoxInfo.SetDefaultFilters)
