...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetLastAchievement)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetLastItem)
...
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetLastScreenshotIndex)
---@return number screenShotIndex
function C_Social.GetLastScreenshotIndex() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetMaxTweetLength)
---@return number maxTweetLength
function C_Social.GetMaxTweetLength() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetScreenshotInfoByIndex)
---@param index number
---@return number screenWidth
---@return number screenHeight
function C_Social.GetScreenshotInfoByIndex(index) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.GetTweetLength)
---@param tweetText string
---@return number tweetLength
function C_Social.GetTweetLength(tweetText) end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.IsSocialEnabled)
---@return boolean isEnabled
function C_Social.IsSocialEnabled() end

---Not allowed to be called by addons
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.TwitterCheckStatus)
function C_Social.TwitterCheckStatus() end

---Not allowed to be called by addons
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.TwitterConnect)
function C_Social.TwitterConnect() end

---Not allowed to be called by addons
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.TwitterDisconnect)
function C_Social.TwitterDisconnect() end

---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.TwitterGetMSTillCanPost)
---@return number msTimeLeft
function C_Social.TwitterGetMSTillCanPost() end

---Not allowed to be called by addons
---[Documentation](https://warcraft.wiki.gg/wiki/API_C_Social.TwitterPostMessage)
