...
---[Documentation](https://wowpedia.fandom.com/wiki/API_Region_GetDrawLayer)
...
---[Documentation](https://wowpedia.fandom.com/wiki/API_Region_GetVertexColor)
...
---[Documentation](https://wowpedia.fandom.com/wiki/API_Region_SetDrawLayer)
...
---[Documentation](https://wowpedia.fandom.com/wiki/API_Region_SetVertexColor)
---@param colorR number
---@param colorG number
---@param colorB number
