...
---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetFillStyle)
function StatusBar:GetFillStyle() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetMinMaxValues)
function StatusBar:GetMinMaxValues() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetOrientation)
function StatusBar:GetOrientation() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetReverseFill)
function StatusBar:GetReverseFill() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetRotatesTexture)
function StatusBar:GetRotatesTexture() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetStatusBarAtlas)
function StatusBar:GetStatusBarAtlas() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetStatusBarColor)
function StatusBar:GetStatusBarColor() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetStatusBarTexture)
function StatusBar:GetStatusBarTexture() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_GetValue)
function StatusBar:GetValue() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetFillStyle)
function StatusBar:SetFillStyle(style) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetMinMaxValues)
function StatusBar:SetMinMaxValues(min, max) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetOrientation)
function StatusBar:SetOrientation(orientation) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetReverseFill)
function StatusBar:SetReverseFill(state) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetRotatesTexture)
function StatusBar:SetRotatesTexture() end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetStatusBarAtlas)
function StatusBar:SetStatusBarAtlas(atlasName) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetStatusBarColor)
function StatusBar:SetStatusBarColor(r, g, b, alpha) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetStatusBarTexture)
function StatusBar:SetStatusBarTexture(texture_or_fileDataIDbool, layer, subLayer) end

---[Documentation](https://wow.gamepedia.com/API_StatusBar_SetValue)
