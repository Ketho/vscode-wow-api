...
---[Documentation](https://wow.gamepedia.com/API_EditBox_ClearHistory)
function EditBox:ClearHistory() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_Disable)
function EditBox:Disable() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_Enable)
function EditBox:Enable() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetAltArrowKeyMode)
function EditBox:GetAltArrowKeyMode() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetBlinkSpeed)
function EditBox:GetBlinkSpeed() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetCursorPosition)
function EditBox:GetCursorPosition() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetDisplayText)
function EditBox:GetDisplayText() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetHighlightColor)
function EditBox:GetHighlightColor() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetHistoryLines)
function EditBox:GetHistoryLines() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetInputLanguage)
function EditBox:GetInputLanguage() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetMaxBytes)
function EditBox:GetMaxBytes() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetMaxLetters)
function EditBox:GetMaxLetters() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetNumLetters)
function EditBox:GetNumLetters() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetNumber)
function EditBox:GetNumber() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetText)
function EditBox:GetText() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetTextInsets)
function EditBox:GetTextInsets() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetUTF8CursorPosition)
function EditBox:GetUTF8CursorPosition() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_GetVisibleTextByteLimit)
function EditBox:GetVisibleTextByteLimit() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_HasFocus)
...
---[Documentation](https://wow.gamepedia.com/API_EditBox_IsCountInvisibleLetters)
function EditBox:IsCountInvisibleLetters() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsEnabled)
function EditBox:IsEnabled() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsInIMECompositionMode)
function EditBox:IsInIMECompositionMode() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsMultiLine)
function EditBox:IsMultiLine() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsNumeric)
function EditBox:IsNumeric() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsPassword)
function EditBox:IsPassword() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_IsSecureText)
...
---[Documentation](https://wow.gamepedia.com/API_EditBox_SetFocus)
function EditBox:SetFocus() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_SetHighlightColor)
...
---[Documentation](https://wow.gamepedia.com/API_EditBox_SetSecurityDisablePaste)
function EditBox:SetSecurityDisablePaste() end

---[Documentation](https://wow.gamepedia.com/API_EditBox_SetSecurityDisableSetText)
