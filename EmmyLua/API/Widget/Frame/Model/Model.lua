...
---[Documentation](https://wow.gamepedia.com/API_Model_AdvanceTime)
function Model:AdvanceTime() end

---[Documentation](https://wow.gamepedia.com/API_Model_ClearFog)
function Model:ClearFog() end

---[Documentation](https://wow.gamepedia.com/API_Model_ClearModel)
function Model:ClearModel() end

---[Documentation](https://wow.gamepedia.com/API_Model_ClearTransform)
function Model:ClearTransform() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetCameraDistance)
function Model:GetCameraDistance() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetCameraFacing)
function Model:GetCameraFacing() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetCameraPosition)
function Model:GetCameraPosition() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetCameraRoll)
function Model:GetCameraRoll() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetCameraTarget)
function Model:GetCameraTarget() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetDesaturation)
function Model:GetDesaturation() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetFacing)
function Model:GetFacing() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetFogColor)
function Model:GetFogColor() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetFogFar)
function Model:GetFogFar() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetFogNear)
function Model:GetFogNear() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetLight)
function Model:GetLight() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetModelAlpha)
function Model:GetModelAlpha() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetModelDrawLayer)
function Model:GetModelDrawLayer() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetModelFileID)
function Model:GetModelFileID() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetModelScale)
function Model:GetModelScale() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetPaused)
function Model:GetPaused() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetPitch)
function Model:GetPitch() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetPosition)
function Model:GetPosition() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetRoll)
function Model:GetRoll() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetShadowEffect)
function Model:GetShadowEffect() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetViewInsets)
function Model:GetViewInsets() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetViewTranslation)
function Model:GetViewTranslation() end

---[Documentation](https://wow.gamepedia.com/API_Model_GetWorldScale)
function Model:GetWorldScale() end

---[Documentation](https://wow.gamepedia.com/API_Model_HasAttachmentPoints)
function Model:HasAttachmentPoints() end

---[Documentation](https://wow.gamepedia.com/API_Model_HasCustomCamera)
function Model:HasCustomCamera() end

---[Documentation](https://wow.gamepedia.com/API_Model_IsUsingModelCenterToTransform)
function Model:IsUsingModelCenterToTransform() end

---[Documentation](https://wow.gamepedia.com/API_Model_MakeCurrentCameraCustom)
