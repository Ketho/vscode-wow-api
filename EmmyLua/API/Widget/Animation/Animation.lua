...
---[Documentation](https://wow.gamepedia.com/API_Animation_GetElapsed)
function Animation:GetElapsed() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetEndDelay)
function Animation:GetEndDelay() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetOrder)
function Animation:GetOrder() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetProgress)
function Animation:GetProgress() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetRegionParent)
function Animation:GetRegionParent() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetSmoothProgress)
function Animation:GetSmoothProgress() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetSmoothing)
function Animation:GetSmoothing() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetStartDelay)
function Animation:GetStartDelay() end

---[Documentation](https://wow.gamepedia.com/API_Animation_GetTarget)
function Animation:GetTarget() end

---[Documentation](https://wow.gamepedia.com/API_Animation_IsDelaying)
function Animation:IsDelaying() end

---[Documentation](https://wow.gamepedia.com/API_Animation_IsDone)
function Animation:IsDone() end

---[Documentation](https://wow.gamepedia.com/API_Animation_IsPaused)
function Animation:IsPaused() end

---[Documentation](https://wow.gamepedia.com/API_Animation_IsPlaying)
function Animation:IsPlaying() end

---[Documentation](https://wow.gamepedia.com/API_Animation_IsStopped)
function Animation:IsStopped() end

---[Documentation](https://wow.gamepedia.com/API_Animation_Pause)
...
---[Documentation](https://wow.gamepedia.com/API_Animation_SetChildKey)
...
---[Documentation](https://wow.gamepedia.com/API_Animation_SetTargetKey)
function Animation:SetTargetKey() end

---[Documentation](https://wow.gamepedia.com/API_Animation_Stop)
