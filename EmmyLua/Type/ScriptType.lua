...
---@alias ScriptEditBox '"OnArrowPressed"' | '"OnCharComposition"' | '"OnCursorChanged"' | '"OnEditFocusGained"' | '"OnEditFocusLost"' | '"OnEnterPressed"' | '"OnEscapePressed"' | '"OnInputLanguageChanged"' | '"OnSpacePressed"' | '"OnTabPressed"' | '"OnTextChanged"' | '"OnTextSet"'
---@alias ScriptFogOfWarFrame '"OnUiMapChanged"'
---@alias ScriptFrame '"OnAttributeChanged"' | '"OnChar"' | '"OnDisable"' | '"OnDragStart"' | '"OnDragStop"' | '"OnEnable"' | '"OnEnter"' | '"OnEvent"' | '"OnGamePadButtonDown"' | '"OnGamePadButtonUp"' | '"OnGamePadStick"' | '"OnHide"' | '"OnHyperlinkClick"' | '"OnHyperlinkEnter"' | '"OnHyperlinkLeave"' | '"OnKeyDown"' | '"OnKeyUp"' | '"OnLeave"' | '"OnMouseDown"' | '"OnMouseUp"' | '"OnMouseWheel"' | '"OnReceiveDrag"' | '"OnShow"' | '"OnSizeChanged"'
---@alias ScriptGameTooltip '"OnTooltipAddMoney"' | '"OnTooltipCleared"' | '"OnTooltipSetAchievement"' | '"OnTooltipSetDefaultAnchor"' | '"OnTooltipSetEquipmentSet"' | '"OnTooltipSetFramestack"' | '"OnTooltipSetItem"' | '"OnTooltipSetQuest"' | '"OnTooltipSetSpell"' | '"OnTooltipSetUnit"'
