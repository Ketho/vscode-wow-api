...
---[Documentation](https://wow.gamepedia.com/EQUIPMENT_SETS_CHANGED)
local EQUIPMENT_SETS_CHANGED = {}

---@class EQUIPMENT_SWAP_FINISHED
---@field result boolean
---@field setID number
---[Documentation](https://wow.gamepedia.com/EQUIPMENT_SWAP_FINISHED)
local EQUIPMENT_SWAP_FINISHED = {}

---@class EQUIPMENT_SWAP_PENDING
---[Documentation](https://wow.gamepedia.com/EQUIPMENT_SWAP_PENDING)
local EQUIPMENT_SWAP_PENDING = {}

---@class TRANSMOG_OUTFITS_CHANGED
---[Documentation](https://wow.gamepedia.com/TRANSMOG_OUTFITS_CHANGED)
local TRANSMOG_OUTFITS_CHANGED = {}

---@class WEAR_EQUIPMENT_SET
---@field setID number
---[Documentation](https://wow.gamepedia.com/WEAR_EQUIPMENT_SET)
