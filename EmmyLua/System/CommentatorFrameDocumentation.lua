...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.AssignPlayerToTeam)
function C_Commentator.AssignPlayerToTeam(playerName, teamName) end

---@param playerName string[]
---@param teamName string
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.AssignPlayersToTeam)
function C_Commentator.AssignPlayersToTeam(playerName, teamName) end

---@param teamIndex number
---@param teamName string
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.AssignPlayersToTeamInCurrentInstance)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.FindSpectatedUnit)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.FlushCommentatorHistory)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetOrCreateSeries)
...
---@return number duration
---@return boolean enable
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetPlayerAuraInfoByUnit)
...
---@return number duration
---@return boolean enable
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetPlayerCooldownInfoByUnit)
...
---@param unitToken string
---@return boolean hasFlag
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetPlayerFlagInfoByUnit)
...
---@return number startTime
---@return number duration
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetPlayerSpellChargesByUnit)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetTeamColor)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.GetUnitData)
...
---@param category TrackedSpellCategory
---@return boolean isTracked
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.IsTrackedSpellByUnit)
...
---@param teamName1 string
---@param teamName2 string
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.ResetSeriesScores)
function C_Commentator.ResetSeriesScores(teamName1, teamName2) end

---[Documentation](https://wow.gamepedia.com/API_C_Commentator.ResetSettings)
...
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.SetCommentatorHistory)
...
---@param score number
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.SetSeriesScore)
...
---@param score1 number
---@param score2 number
---[Documentation](https://wow.gamepedia.com/API_C_Commentator.SetSeriesScores)
