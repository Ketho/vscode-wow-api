...
---@class CHAT_MSG_CHANNEL_LEAVE_PREVENTED
---@field channelName string
---[Documentation](https://wow.gamepedia.com/CHAT_MSG_CHANNEL_LEAVE_PREVENTED)
local CHAT_MSG_CHANNEL_LEAVE_PREVENTED = {}
...
---@class CHAT_REGIONAL_SEND_FAILED
---[Documentation](https://wow.gamepedia.com/CHAT_REGIONAL_SEND_FAILED)
local CHAT_REGIONAL_SEND_FAILED = {}

---@class CHAT_REGIONAL_STATUS_CHANGED
---@field isServiceAvailable boolean
---[Documentation](https://wow.gamepedia.com/CHAT_REGIONAL_STATUS_CHANGED)
local CHAT_REGIONAL_STATUS_CHANGED = {}
