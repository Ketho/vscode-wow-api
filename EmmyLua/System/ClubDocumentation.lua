...
---[Documentation](https://wow.gamepedia.com/AVATAR_LIST_UPDATED)
local AVATAR_LIST_UPDATED = {}

---@class CLUB_ADDED
---@field clubId string
---[Documentation](https://wow.gamepedia.com/CLUB_ADDED)
local CLUB_ADDED = {}
...
---[Documentation](https://wow.gamepedia.com/CLUB_MEMBER_PRESENCE_UPDATED)
local CLUB_MEMBER_PRESENCE_UPDATED = {}

---@class CLUB_MEMBER_REMOVED
---@field clubId string
---@field memberId number
---[Documentation](https://wow.gamepedia.com/CLUB_MEMBER_REMOVED)
...
---@field memberId number
---@field roleId number
---[Documentation](https://wow.gamepedia.com/CLUB_MEMBER_ROLE_UPDATED)
local CLUB_MEMBER_ROLE_UPDATED = {}

---@class CLUB_MEMBER_UPDATED
---@field clubId string
---@field memberId number
---[Documentation](https://wow.gamepedia.com/CLUB_MEMBER_UPDATED)
...
---[Documentation](https://wow.gamepedia.com/CLUB_MESSAGE_ADDED)
...
---[Documentation](https://wow.gamepedia.com/CLUB_MESSAGE_HISTORY_RECEIVED)
...
---@field streamId string
---@field messageId ClubMessageIdentifier
---[Documentation](https://wow.gamepedia.com/CLUB_MESSAGE_UPDATED)
local CLUB_MESSAGE_UPDATED = {}

---@class CLUB_REMOVED
---@field clubId string
---[Documentation](https://wow.gamepedia.com/CLUB_REMOVED)
local CLUB_REMOVED = {}

---@class CLUB_REMOVED_MESSAGE
---@field clubName string
---@field clubRemovedReason ClubRemovedReason
---[Documentation](https://wow.gamepedia.com/CLUB_REMOVED_MESSAGE)
local CLUB_REMOVED_MESSAGE = {}

---@class CLUB_SELF_MEMBER_ROLE_UPDATED
---@field clubId string
---@field roleId number
---[Documentation](https://wow.gamepedia.com/CLUB_SELF_MEMBER_ROLE_UPDATED)
local CLUB_SELF_MEMBER_ROLE_UPDATED = {}

---@class CLUB_STREAM_ADDED
---@field clubId string
---@field streamId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAM_ADDED)
local CLUB_STREAM_ADDED = {}

---@class CLUB_STREAM_REMOVED
---@field clubId string
---@field streamId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAM_REMOVED)
local CLUB_STREAM_REMOVED = {}

---@class CLUB_STREAM_SUBSCRIBED
---@field clubId string
---@field streamId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAM_SUBSCRIBED)
local CLUB_STREAM_SUBSCRIBED = {}

---@class CLUB_STREAM_UNSUBSCRIBED
---@field clubId string
---@field streamId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAM_UNSUBSCRIBED)
local CLUB_STREAM_UNSUBSCRIBED = {}

---@class CLUB_STREAM_UPDATED
---@field clubId string
---@field streamId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAM_UPDATED)
local CLUB_STREAM_UPDATED = {}

---@class CLUB_STREAMS_LOADED
---@field clubId string
---[Documentation](https://wow.gamepedia.com/CLUB_STREAMS_LOADED)
local CLUB_STREAMS_LOADED = {}

---@class CLUB_TICKET_CREATED
---@field clubId string
---@field ticketInfo ClubTicketInfo
---[Documentation](https://wow.gamepedia.com/CLUB_TICKET_CREATED)
local CLUB_TICKET_CREATED = {}

---@class CLUB_TICKET_RECEIVED
---@field ticket string
---[Documentation](https://wow.gamepedia.com/CLUB_TICKET_RECEIVED)
local CLUB_TICKET_RECEIVED = {}

---@class CLUB_TICKETS_RECEIVED
---@field clubId string
---[Documentation](https://wow.gamepedia.com/CLUB_TICKETS_RECEIVED)
local CLUB_TICKETS_RECEIVED = {}

---@class CLUB_UPDATED
---@field clubId string
---[Documentation](https://wow.gamepedia.com/CLUB_UPDATED)
local CLUB_UPDATED = {}

---@class INITIAL_CLUBS_LOADED
---[Documentation](https://wow.gamepedia.com/INITIAL_CLUBS_LOADED)
...
---[Documentation](https://wow.gamepedia.com/STREAM_VIEW_MARKER_UPDATED)
