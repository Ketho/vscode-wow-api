...
---[Documentation](https://wow.gamepedia.com/BARBER_SHOP_COST_UPDATE)
local BARBER_SHOP_COST_UPDATE = {}

---@class BARBER_SHOP_FORCE_CUSTOMIZATIONS_UPDATE
---[Documentation](https://wow.gamepedia.com/BARBER_SHOP_FORCE_CUSTOMIZATIONS_UPDATE)
local BARBER_SHOP_FORCE_CUSTOMIZATIONS_UPDATE = {}

---@class BARBER_SHOP_OPEN
---[Documentation](https://wow.gamepedia.com/BARBER_SHOP_OPEN)
local BARBER_SHOP_OPEN = {}

---@class BARBER_SHOP_RESULT
---@field success boolean
---[Documentation](https://wow.gamepedia.com/BARBER_SHOP_RESULT)
local BARBER_SHOP_RESULT = {}
