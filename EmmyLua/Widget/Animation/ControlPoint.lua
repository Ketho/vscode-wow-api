...
---[Documentation](https://wow.gamepedia.com/API_ControlPoint_GetOffset)
function ControlPoint:GetOffset() end

---[Documentation](https://wow.gamepedia.com/API_ControlPoint_GetOrder)
function ControlPoint:GetOrder() end

---[Documentation](https://wow.gamepedia.com/API_ControlPoint_SetOffset)
