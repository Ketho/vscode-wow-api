...
---[Documentation](https://wow.gamepedia.com/API_Scale_GetFromScale)
function Scale:GetFromScale() end

---[Documentation](https://wow.gamepedia.com/API_Scale_GetOrigin)
function Scale:GetOrigin() end

---[Documentation](https://wow.gamepedia.com/API_Scale_GetScale)
function Scale:GetScale() end

---[Documentation](https://wow.gamepedia.com/API_Scale_GetToScale)
