...
---[Documentation](https://wow.gamepedia.com/API_GameTooltip_CopyTooltip)
function GameTooltip:CopyTooltip() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_FadeOut)
function GameTooltip:FadeOut() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetAnchorType)
function GameTooltip:GetAnchorType() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetAzeritePowerID)
function GameTooltip:GetAzeritePowerID() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetItem)
function GameTooltip:GetItem() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetMinimumWidth)
function GameTooltip:GetMinimumWidth() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetOwner)
function GameTooltip:GetOwner() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetPadding)
function GameTooltip:GetPadding() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetSpell)
function GameTooltip:GetSpell() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_GetUnit)
function GameTooltip:GetUnit() end

---[Documentation](https://wow.gamepedia.com/API_GameTooltip_IsEquippedItem)
...
---[Documentation](https://wow.gamepedia.com/API_GameTooltip_ResetSecondaryCompareItem)
...
---[Documentation](https://wow.gamepedia.com/API_GameTooltip_SetArtifactPowerByID)
