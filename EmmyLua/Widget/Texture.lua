...
function Texture:AddMaskTexture() end
...
function Texture:GetMaskTexture() end
...
function Texture:GetVertexOffset() end
...
function Texture:RemoveMaskTexture() end
...
function Texture:SetGradient() end

---[Documentation](https://wow.gamepedia.com/API_Texture_SetGradientAlpha)
function Texture:SetGradientAlpha() end
...
function Texture:SetVertexOffset() end
