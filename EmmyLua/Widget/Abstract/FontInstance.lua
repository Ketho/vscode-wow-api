...
---[Documentation](https://wow.gamepedia.com/UIOBJECT_FontInstance)
local FontInstance = {}

---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetFont)
function FontInstance:GetFont() end

---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetFontObject)
...
---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetJustifyH)
function FontInstance:GetJustifyH() end

---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetJustifyV)
function FontInstance:GetJustifyV() end

---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetSpacing)
function FontInstance:GetSpacing() end

---[Documentation](https://wow.gamepedia.com/API_FontInstance_SetIndentedWordWrap)
...
---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetShadowOffset)
function FontInstance:GetShadowOffset() end

---[Documentation](https://wow.gamepedia.com/API_FontInstance_GetTextColor)
