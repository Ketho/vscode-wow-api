...
export const data: CVarInterface = {
	...
	actioncombatcameraenable: {
		name: "ActionCombatCameraEnable",
		default: "0",
		category: 5,
		help: "enable/disable action combat camera. (default: disabled)",
	},
	...
	caaenabled: {
		...
		category: 4,
		scope: "Character",
		help: "Enable or disable combat audio alerts",
	},
	caainterruptcast: {
		name: "CAAInterruptCast",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Announce when the target starts casting something interruptible",
	},
	caainterruptcastsuccess: {
		name: "CAAInterruptCastSuccess",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Announce when the target's cast is interrupted",
	},
	caapartyhealthfrequency: {
		name: "CAAPartyHealthFrequency",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Relative frequency at which party health combat audio alerts are read (-10 to 10). -10 halves the frequency and 10 doubles it",
	},
	caapartyhealthpercent: {
		name: "CAAPartyHealthPercent",
		default: "0",
		category: 4,
		scope: "Character",
	...
	caaplayercastformat: {
		...
		category: 4,
		scope: "Character",
		help: "Format string to use when reading the player's casts",
	},
	caaplayercastmintime: {
		name: "CAAPlayerCastMinTime",
		default: "1.500000",
		category: 4,
		scope: "Character",
		help: "The player's casts will only be read out if they have a cast time >= this",
	},
	caaplayercastmode: {
		name: "CAAPlayerCastMode",
		default: "0",
		category: 4,
		scope: "Character",
		help: "When the player's casts should be announced (0=off, 1=cast start, 2=cast end)",
	},
	caaplayercastthrottle: {
		name: "CAAPlayerCastThrottle",
		default: "0.000000",
		category: 4,
		scope: "Character",
	...
	caaplayerhealthformat: {
		...
		category: 4,
		scope: "Character",
		help: "Format string to use when reading the player's health",
	},
	caaplayerhealthpercent: {
		name: "CAAPlayerHealthPercent",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Announce player health every X percent",
	},
	caaplayerhealththrottle: {
		name: "CAAPlayerHealthThrottle",
		default: "0.000000",
		category: 4,
		scope: "Character",
	...
	caaresource1formats: {
		...
		category: 4,
		scope: "Account",
		help: "Stores the format string to use (for each spec) when announcing the player's first resource",
	},
	caaresource1percents: {
		name: "CAAResource1Percents",
		default: "",
		category: 4,
		scope: "Account",
		help: "Stores the percentage band sizes to use (for each spec) when announcing the player's first resource ",
	},
	caaresource1throttle: {
		name: "CAAResource1Throttle",
		default: "0.000000",
		category: 4,
		scope: "Account",
	...
	caaresource2formats: {
		...
		category: 4,
		scope: "Account",
		help: "Stores the format string to use (for each spec) when announcing the player's second resource",
	},
	caaresource2percents: {
		name: "CAAResource2Percents",
		default: "",
		category: 4,
		scope: "Account",
		help: "Stores the percentage band sizes to use (for each spec) when announcing the player's second resource",
	},
	caaresource2throttle: {
		name: "CAAResource2Throttle",
		default: "0.000000",
		category: 4,
		scope: "Account",
	...
	caasaycombatend: {
		...
		category: 4,
		scope: "Character",
		help: "Announce when combat ends",
	},
	caasaycombatstart: {
		name: "CAASayCombatStart",
		default: "1",
		category: 4,
		scope: "Character",
		help: "Announce when combat starts",
	},
	caasayiftargeted: {
		name: "CAASayIfTargeted",
		default: "",
		category: 4,
		scope: "Account",
		help: "Stores the 'say if targeted' settings for each spec",
	},
	caasaytargetname: {
		name: "CAASayTargetName",
		default: "1",
		category: 4,
		scope: "Character",
	...
	caaspeed: {
		...
		category: 4,
		scope: "Character",
		help: "Speed at which combat audio alerts are read (-10 to 10)",
	},
	caatargetcastformat: {
		name: "CAATargetCastFormat",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Format string to use when reading the target's casts",
	},
	caatargetcastmintime: {
		name: "CAATargetCastMinTime",
		default: "1.500000",
		category: 4,
		scope: "Character",
		help: "The target's casts will only be read out if they have a cast time >= this",
	},
	caatargetcastmode: {
		name: "CAATargetCastMode",
		default: "0",
		category: 4,
		scope: "Character",
		help: "When the target's casts should be announced (0=off, 1=cast start, 2=cast end)",
	},
	caatargetcastthrottle: {
		name: "CAATargetCastThrottle",
		default: "0.000000",
		category: 4,
		scope: "Character",
	...
	caatargetdeathbehavior: {
		...
		category: 4,
		scope: "Character",
		help: "Behavior of announcement when target dies (0=default, 1=target dead)",
	},
	caatargethealthformat: {
		name: "CAATargetHealthFormat",
		default: "3",
		category: 4,
		scope: "Character",
		help: "Format string to use when reading the target's health",
	},
	caatargethealthpercent: {
		name: "CAATargetHealthPercent",
		default: "2",
		category: 4,
		scope: "Character",
		help: "Announce target health every X percent",
	},
	caatargethealththrottle: {
		name: "CAATargetHealthThrottle",
		default: "0.000000",
		category: 4,
		scope: "Character",
	...
	caavolume: {
		...
		category: 4,
		scope: "Character",
		help: "Volume of combat audio alerts (0 to 100)",
	},
	cmaa2extrasharpness: {
	...
	clientsettings_lowvramactions: {
		name: "ClientSettings_LowVramActions",
		default: "",
		category: 5,
	},
	clientsettings_msaa: {
	...
	gxcompatasynccomputequeue: {
		name: "GxCompatAsyncComputeQueue",
		default: "1",
		category: 5,
		help: "Allows some compute work to run on a different GPU work queue",
	},
	...
	gxcompatcopyqueue: {
		name: "GxCompatCopyQueue",
		default: "1",
		category: 5,
		help: "Allows GPU upload work to run on a different GPU work queue",
	},
	...
	invalidatedeactivatedhandles: {
		name: "InvalidateDeactivatedHandles",
		default: "1",
		category: 0,
		help: "Turn on to treat WowCS Handles as invalid if referring to a deactivated entity",
	},
	...
	lowlatencymininterval: {
		name: "LowLatencyMinInterval",
		default: "0",
		category: 1,
		help: "Min frame time (in microseconds) for Low Latency systems. Pass -1 to use monitor's refresh rate.",
	},
	lowlatencymode: {
		name: "LowLatencyMode",
		default: "0",
	...
	renderformat: {
		...
		default: "0",
		category: 1,
		help: "0 = BGRA8Unorm, 1 = A2BGR10Unorm, 2 = RGBA16F, 3 = RGBA32F",
	},
	renderscale: {
		name: "RenderScale",
		default: "1.000000",
	...
	renderscaledowngradebackgroundminsize: {
		name: "RenderScaleDowngradeBackgroundMinSize",
		default: "720",
		category: 1,
		help: "Min size (in pixels) we can reduce render scale to when under high VRAM pressure when the game does not has focus",
	},
	renderscaledowngradeforegroundminsize: {
		name: "RenderScaleDowngradeForegroundMinSize",
		default: "1080",
		category: 1,
		help: "Min size (in pixels) we can reduce render scale to when under high VRAM pressure when the game has focus",
	},
	...
	sound_enableencounterwarningssounds: {
		name: "Sound_EnableEncounterWarningsSounds",
		default: "1",
		category: 7,
		help: "Enable Encounter Warnings Sounds",
	},
	...
	sound_encounterwarningsvolume: {
		name: "Sound_EncounterWarningsVolume",
		default: "1.000000",
		category: 7,
		help: "Encounter Warnings Volume (0.0 to 1.0)",
	},
	...
	accountneedsturnstrafedialog: {
		...
		category: 4,
		scope: "Character",
		help: "Whether the account needs to show dialog that turn and strafe keybinds have changed",
	},
	...
	alwaysshowruneicons: {
		name: "alwaysShowRuneIcons",
		default: "0",
		category: 10,
		scope: "Character",
		help: "Show the rune icons on equipment at all times, as opposed to only when the rune UI is open.",
	},
	animframeskiplod: {
	...
	assistedcombathighlightrpe: {
		name: "assistedCombatHighlightRPE",
		default: "0",
		category: 4,
		scope: "Account",
		help: "Will be true if Assisted Highlight was automatically enabled by RPE. Will reset when leaving RPE.",
	},
	...
	auctionsortbybuyoutprice: {
		name: "auctionSortByBuyoutPrice",
		default: "0",
		category: 4,
		scope: "Account",
		help: "Sort auction items by buyout price instead of current bid price",
	},
	auctionsortbyunitprice: {
		name: "auctionSortByUnitPrice",
		default: "0",
		category: 4,
		scope: "Account",
		help: "Sort auction items by unit price instead of total stack price",
	},
	audiolocale: {
		name: "audioLocale",
		default: "",
	...
	characterneedsturnstrafedialog: {
		name: "characterNeedsTurnStrafeDialog",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Whether the character needs to show dialog that turn and strafe keybinds have changed",
	},
	...
	chatbubblesraid: {
		name: "chatBubblesRaid",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Whether to show in-game chat bubbles for raid chat",
	},
	...
	closedremixartifacttutorialframes: {
		name: "closedRemixArtifactTutorialFrames",
		default: "0",
		category: 4,
		scope: "Account",
		help: "Tutorial bitfield for which Remix Artifacts have been shown so far",
	},
	...
	collapseexpandbuffs: {
		name: "collapseExpandBuffs",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Enables a button to collapse and hide long duration buffs.",
	},
	...
	combatwarningsenabled: {
		name: "combatWarningsEnabled",
		default: "1",
		category: 4,
		scope: "Character",
		help: "If set, enables combat warning UI functionality such as the boss timeline or warnings displays",
	},
	combinedbags: {
		name: "combinedBags",
		default: "0",
	...
	cooldownviewershowunlearned: {
		name: "cooldownViewerShowUnlearned",
		default: "1",
		category: 4,
		scope: "Character",
		help: "In the cooldown viewer settings UI, determines whether or not to show unlearned cooldowns",
	},
	...
	disablesuggestedlevelactivityfilter: {
		name: "disableSuggestedLevelActivityFilter",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Whether to disable filtering the activity list by the user's level.",
	},
	...
	encountertimelineenabled: {
		name: "encounterTimelineEnabled",
		default: "1",
		category: 4,
		scope: "Character",
		help: "If true, enable the encounter timeline UI.",
	},
	encountertimelinehideforotherroles: {
		name: "encounterTimelineHideForOtherRoles",
		default: "0",
		category: 4,
		scope: "Character",
		secure: true,
	...
	encountertimelinehidelongcountdowns: {
		name: "encounterTimelineHideLongCountdowns",
		default: "0",
		category: 4,
		scope: "Character",
		help: "If true, hide all long countdowns from the timeline.",
	},
	encountertimelinehidequeuedcountdowns: {
		name: "encounterTimelineHideQueuedCountdowns",
		default: "0",
		category: 4,
		scope: "Character",
	...
	encounterwarningsdefaultmessageduration: {
		...
		category: 4,
		scope: "Character",
		help: "Default duration (in milliseconds) applied to encounter warning text messages",
	},
	encounterwarningsenabled: {
		name: "encounterWarningsEnabled",
		default: "1",
		category: 4,
		scope: "Character",
		help: "If true, enable the display of encounter warning messages",
	},
	encounterwarningshideifnottargetingplayer: {
		name: "encounterWarningsHideIfNotTargetingPlayer",
		default: "0",
		category: 4,
		scope: "Character",
		secure: true,
	...
	equipmentmanager: {
		...
		category: 4,
		scope: "Account",
		help: "Enables the equipment management UI",
	},
	eventreminders: {
		name: "eventReminders",
		default: "",
	...
	externaldefensivesenabled: {
		name: "externalDefensivesEnabled",
		default: "0",
		category: 4,
		scope: "Account",
		help: "If true, show the external defensives buff tracker UI.",
	},
	farclip: {
		name: "farclip",
		default: "1000",
	...
	guildmembernotify: {
		...
		category: 4,
		scope: "Character",
		help: "Whether to notify when guild members come online or go offline",
	},
	guildnewsfilter: {
	...
	hardcoredeathalerttype: {
		name: "hardcoreDeathAlertType",
		default: "0",
		category: 4,
		scope: "Character",
	},
	hardcoredeathchattype: {
		name: "hardcoreDeathChatType",
		default: "0",
		category: 4,
		scope: "Character",
	},
	...
	housingdecorfreeplaceenabled: {
		...
		category: 4,
		scope: "Character",
		help: "Whether or not free placement in decor edit modes is enabled",
	},
	housingdecorgridsnapenabled: {
		name: "housingDecorGridSnapEnabled",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Whether or not snap-to-grid in decor edit modes is enabled",
	},
	housingdecorgridvisible: {
		name: "housingDecorGridVisible",
		default: "1",
		category: 4,
		scope: "Character",
		help: "Whether or not the grid in decor edit modes is visible",
	},
	housingexpertgizmos_scale_frameoffset: {
		name: "housingExpertGizmos_Scale_FrameOffset",
		default: "0.500000",
		category: 10,
		help: "Y Offset of scale frame from target",
	},
	housingexpertgizmos_scale_snap: {
		name: "housingExpertGizmos_Scale_Snap",
		default: "0.100000",
		category: 10,
		help: "Amount scale should snap (0.1 being 10%, 1 being 100%, etc)",
	},
	housingexpertgizmos_snaponhold: {
		name: "housingExpertGizmos_SnapOnHold",
		default: "1",
		category: 10,
		help: "true: Holding shift turns expert control snapping on, false: Holding shift turns snapping off",
	},
	housinglayout_camera_defaultdistance: {
		name: "housingLayout_Camera_DefaultDistance",
		default: "50.000000",
		category: 10,
		help: "Default height of the layout edit mode camera above the floor",
	},
	housinglayout_camera_dragfriction: {
		name: "housingLayout_Camera_DragFriction",
		default: "8.000000",
		category: 10,
		help: "How quickly the camera loses drag momentum",
	},
	housinglayout_camera_dragmomentum: {
		name: "housingLayout_Camera_DragMomentum",
		default: "0.300000",
		category: 10,
		help: "How much momentum does the camera have after the user stops dragging",
	},
	housinglayout_camera_maxdistance: {
		name: "housingLayout_Camera_MaxDistance",
		default: "80.000000",
		category: 10,
		help: "Maximum height of the layout edit mode camera above the floor",
	},
	housinglayout_camera_maxdistanceincr: {
		name: "housingLayout_Camera_MaxDistanceIncr",
		default: "5.000000",
		category: 10,
		help: "How much zoom in/out of the layout edit mode camera affects distance from the floor",
	},
	housinglayout_camera_mindistance: {
		name: "housingLayout_Camera_MinDistance",
		default: "30.000000",
		category: 10,
		help: "Minimum height of the layout edit mode camera above the floor",
	},
	housinglayout_camera_smoothness: {
		name: "housingLayout_Camera_Smoothness",
		default: "15.000000",
		category: 10,
		help: "Smoothness factor of layout camera movement",
	},
	housinglayout_camera_speed: {
		name: "housingLayout_Camera_Speed",
		default: "15.000000",
		category: 10,
		help: "Units/second that the layout edit mode camera moves",
	},
	housingstoragepanelcollapsed: {
		name: "housingStoragePanelCollapsed",
		default: "0",
		category: 4,
		help: "Whether the housing storage panel is collapsed",
	},
	housingstoragepanelheight: {
		name: "housingStoragePanelHeight",
		default: "615.000000",
		category: 4,
		scope: "Character",
		help: "The saved height of the housing storage panel",
	},
	housingstoragepanelwidth: {
		name: "housingStoragePanelWidth",
		default: "530.000000",
		category: 4,
		scope: "Character",
		help: "The saved width of the housing storage panel",
	},
	housingtutorialsenabled: {
		name: "housingTutorialsEnabled",
		default: "1",
		category: 4,
		help: "Housing tutorials enabled or disabled",
	},
	hwdetect: {
		name: "hwDetect",
		default: "1",
	...
	lastlaunchedexternaleventurl: {
		name: "lastLaunchedExternalEventURL",
		default: "",
		category: 4,
		scope: "Character",
	},
	...
	lasttransmogcustomsetidnospec: {
		name: "lastTransmogCustomSetIDNoSpec",
		default: "",
		category: 4,
		scope: "Account",
		help: "SetID of the last applied transmog custom set",
	},
	lasttransmogcustomsetidspec1: {
		name: "lastTransmogCustomSetIDSpec1",
		default: "",
		category: 4,
		scope: "Account",
		help: "SetID of the last applied transmog custom set for the 1st spec",
	},
	lasttransmogcustomsetidspec2: {
		name: "lastTransmogCustomSetIDSpec2",
		default: "",
		category: 4,
		scope: "Account",
		help: "SetID of the last applied transmog custom set for the 2nd spec",
	},
	lasttransmogcustomsetidspec3: {
		name: "lastTransmogCustomSetIDSpec3",
		default: "",
		category: 4,
		scope: "Account",
		help: "SetID of the last applied transmog custom set for the 3rd spec",
	},
	lasttransmogcustomsetidspec4: {
		name: "lastTransmogCustomSetIDSpec4",
		default: "",
		category: 4,
		scope: "Account",
		help: "SetID of the last applied transmog custom set for the 4th spec",
	},
	lasttransmogoutfitidnospec: {
		name: "lastTransmogOutfitIDNoSpec",
		default: "",
		category: 4,
		scope: "Account",
	...
	lfglistadvancedfiltersversion: {
		name: "lfgListAdvancedFiltersVersion",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Version for lfgListAdvancedFilters",
	},
	...
	majorfactionrenownmap: {
		name: "majorFactionRenownMap",
		default: "",
		category: 4,
		scope: "Character",
		help: "Serialized mapping of faction ID to last known renown rank/level. Updated when the Renown UI is closed, used to control animations in the Major Faction UI.",
	},
	mapfade: {
		name: "mapFade",
		default: "1",
	...
	movepadinpressandholdmode: {
		name: "movePadInPressAndHoldMode",
		default: "0",
		category: 4,
		scope: "Character",
		help: "When true the MovePad buttons are activated on mouse down and deactivated on mouse up",
	},
	movepadlocked: {
		name: "movePadLocked",
		default: "1",
		category: 4,
		scope: "Character",
		help: "When false the MovePad can be moved by the player",
	},
	moviesubtitle: {
		name: "movieSubtitle",
		default: "1",
	...
	nameplateshowall: {
		...
		category: 4,
		scope: "Character",
		help: "Whether all nameplates are shown, including enemies, friendly NPCs, pets, guardians, and totems.",
	},
	nameplateshowcastbars: {
		name: "nameplateShowCastBars",
		default: "1",
		category: 4,
		scope: "Account",
		secure: true,
		help: "Show cast bars for unit nameplates.",
	},
	nameplateshowclasscolor: {
		name: "nameplateShowClassColor",
		default: "1",
		category: 4,
		secure: true,
		help: "Used to display the class color in enemy nameplate health bars",
	},
	nameplateshowdebuffsonfriendly: {
		...
		scope: "Account",
		secure: true,
		help: "Whether debuffs are shown on friendly nameplates.",
	},
	nameplateshowenemies: {
		...
		category: 4,
		scope: "Character",
		help: "Whether enemy nameplates are shown.",
	},
	nameplateshowenemyguardians: {
		...
		scope: "Character",
		secure: true,
		help: "Whether enemy guardian nameplates are shown.",
	},
	nameplateshowenemyminions: {
		...
		category: 4,
		scope: "Character",
		help: "Whether enemy minion nameplates are shown.",
	},
	nameplateshowenemyminus: {
		...
		scope: "Character",
		secure: true,
		help: "Whether enemy nameplates for entities with a minus sign (indicating they are weaker than the player) are shown.",
	},
	nameplateshowenemypets: {
		...
		scope: "Character",
		secure: true,
		help: "Whether enemy pet nameplates are shown.",
	},
	nameplateshowenemytotems: {
		...
		scope: "Character",
		secure: true,
		help: "Whether enemy totem nameplates are shown.",
	},
	nameplateshowfriendlyclasscolor: {
		name: "nameplateShowFriendlyClassColor",
		default: "1",
		category: 4,
		secure: true,
		help: "Used to display the class color in friendly nameplate health bars",
	},
	nameplateshowfriendlynpcs: {
		...
		category: 4,
		scope: "Character",
		help: "Whether nameplates are shown for friendly npcs.",
	},
	nameplateshowfriendlyplayerguardians: {
		name: "nameplateShowFriendlyPlayerGuardians",
		default: "0",
		category: 4,
		scope: "Character",
		secure: true,
		help: "Whether friendly player guardian nameplates are shown.",
	},
	nameplateshowfriendlyplayerminions: {
		name: "nameplateShowFriendlyPlayerMinions",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Whether friendly player minion nameplates are shown.",
	},
	nameplateshowfriendlyplayerpets: {
		name: "nameplateShowFriendlyPlayerPets",
		default: "0",
		category: 4,
		scope: "Character",
		secure: true,
		help: "Whether friendly player pet nameplates are shown.",
	},
	nameplateshowfriendlyplayertotems: {
		name: "nameplateShowFriendlyPlayerTotems",
		default: "0",
		category: 4,
		scope: "Character",
		secure: true,
		help: "Whether friendly player totem nameplates are shown.",
	},
	nameplateshowfriendlyplayers: {
		name: "nameplateShowFriendlyPlayers",
		default: "0",
		category: 4,
		scope: "Character",
	...
	nameplateshowonlynameforfriendlyplayerunits: {
		name: "nameplateShowOnlyNameForFriendlyPlayerUnits",
		default: "0",
		category: 4,
		secure: true,
		help: "Used to hide every part of the nameplate but the name for friendly player units.",
	},
	nameplateshowself: {
	...
	optoutingamesurveys: {
		name: "optOutIngameSurveys",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Whether we are opted out of receiving surveys.",
	},
	...
	petjournalfilterversion: {
		name: "petJournalFilterVersion",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Current filter version. Will reset all filters to their defaults if out of date.",
	},
	petjournalfilters: {
	...
	raidframescenterbigdefensive: {
		name: "raidFramesCenterBigDefensive",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Show big defensive raid buffs in the center of the unit frame",
	},
	raidframesdispelindicatoroverlay: {
		name: "raidFramesDispelIndicatorOverlay",
		default: "1",
		category: 4,
		scope: "Account",
		help: "When showing dispel indicators, also show a color gradient overlay",
	},
	raidframesdispelindicatortype: {
		name: "raidFramesDispelIndicatorType",
		default: "2",
		category: 4,
		scope: "Account",
		help: "Choose which dispel icon indicators to show in raid frames",
	},
	...
	raidframesdisplaylargerrolespecificdebuffs: {
		name: "raidFramesDisplayLargerRoleSpecificDebuffs",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Show role-specific debuffs as larger on Raid Frames",
	},
	...
	showallitemsintransmog: {
		name: "showAllItemsInTransmog",
		default: "0",
		category: 4,
		help: "Shows all items in the transmogger regardless of armor restrictions",
	},
	...
	showcustomsetdetails: {
		name: "showCustomSetDetails",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Whether or not to show custom set details when the dressing room is opened in maximized mode, default on",
	},
	...
	spelldiminishpvpenemiesenabled: {
		name: "spellDiminishPVPEnemiesEnabled",
		default: "1",
		category: 4,
		scope: "Account",
		help: "Determines if we should show crowd control diminishing returns on enemy unit frames in arenas",
	},
	spelldiminishpvponlytriggerablebyme: {
		name: "spellDiminishPVPOnlyTriggerableByMe",
		default: "0",
		category: 4,
		scope: "Account",
		help: "Determines if we should show crowd control diminishing returns for all categories or only the ones you could cause with your spells",
	},
	...
	trackedinitiativetasks: {
		...
		category: 4,
		scope: "Account",
		help: "Internal cvar for saving tracked initiative tasks in order",
	},
	...
	transmogrifysetsfilters: {
		name: "transmogrifySetsFilters",
		default: "0",
		category: 4,
		scope: "Character",
		help: "Bitfield for which transmog sets filters are applied in the transmog sets tab",
	},
	...
	usetargetfps: {
		...
		default: "1",
		category: 1,
		help: "Enables or disables the target FPS",
	},
	useuiscale: {
		name: "useUiScale",
		default: "0",
