...
local data = {
	...
	{ Name = "Enum.InventoryType", W_Link = "Enum.InventoryType" }, -- always link
	{ Name = "Enum.ItemQuality", W_Link = "Enum.ItemQuality" }, -- always link
	{ Name = "Enum.PowerType", W_Link = "Enum.PowerType" }, -- always link
