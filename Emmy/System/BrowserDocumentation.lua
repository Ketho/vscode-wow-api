...
---[Documentation](https://wow.gamepedia.com/SIMPLE_BROWSER_WEB_ERROR)
local SIMPLE_BROWSER_WEB_ERROR = {}

---@class SIMPLE_BROWSER_WEB_PROXY_FAILED
---[Documentation](https://wow.gamepedia.com/SIMPLE_BROWSER_WEB_PROXY_FAILED)
local SIMPLE_BROWSER_WEB_PROXY_FAILED = {}

---@class SIMPLE_CHECKOUT_CLOSED
---[Documentation](https://wow.gamepedia.com/SIMPLE_CHECKOUT_CLOSED)
