...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_ABILITY_CHANGED)
local PET_BATTLE_ABILITY_CHANGED = {}

---@class PET_BATTLE_ACTION_SELECTED
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_ACTION_SELECTED)
...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_AURA_APPLIED)
...
---@field petIndex number
---@field auraInstanceID number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_AURA_CANCELED)
...
---@field petIndex number
---@field auraInstanceID number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_AURA_CHANGED)
local PET_BATTLE_AURA_CHANGED = {}

---@class PET_BATTLE_CAPTURED
---@field owner number
---@field petIndex number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_CAPTURED)
local PET_BATTLE_CAPTURED = {}

---@class PET_BATTLE_CLOSE
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_CLOSE)
local PET_BATTLE_CLOSE = {}

---@class PET_BATTLE_FINAL_ROUND
---@field owner number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_FINAL_ROUND)
...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_HEALTH_CHANGED)
...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_LEVEL_CHANGED)
...
---@field petIndex number
---@field healthChange number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_MAX_HEALTH_CHANGED)
local PET_BATTLE_MAX_HEALTH_CHANGED = {}

---@class PET_BATTLE_OPENING_DONE
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_OPENING_DONE)
local PET_BATTLE_OPENING_DONE = {}

---@class PET_BATTLE_OPENING_START
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_OPENING_START)
local PET_BATTLE_OPENING_START = {}

---@class PET_BATTLE_OVER
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_OVER)
local PET_BATTLE_OVER = {}

---@class PET_BATTLE_OVERRIDE_ABILITY
---@field abilityIndex number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_OVERRIDE_ABILITY)
local PET_BATTLE_OVERRIDE_ABILITY = {}

---@class PET_BATTLE_PET_CHANGED
---@field owner number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PET_CHANGED)
local PET_BATTLE_PET_CHANGED = {}

---@class PET_BATTLE_PET_ROUND_PLAYBACK_COMPLETE
---@field roundNumber number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PET_ROUND_PLAYBACK_COMPLETE)
local PET_BATTLE_PET_ROUND_PLAYBACK_COMPLETE = {}

---@class PET_BATTLE_PET_ROUND_RESULTS
---@field roundNumber number
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PET_ROUND_RESULTS)
...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PET_TYPE_CHANGED)
local PET_BATTLE_PET_TYPE_CHANGED = {}

---@class PET_BATTLE_PVP_DUEL_REQUEST_CANCEL
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PVP_DUEL_REQUEST_CANCEL)
local PET_BATTLE_PVP_DUEL_REQUEST_CANCEL = {}

---@class PET_BATTLE_PVP_DUEL_REQUESTED
---@field fullName string
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_PVP_DUEL_REQUESTED)
local PET_BATTLE_PVP_DUEL_REQUESTED = {}

---@class PET_BATTLE_QUEUE_PROPOSAL_ACCEPTED
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_QUEUE_PROPOSAL_ACCEPTED)
local PET_BATTLE_QUEUE_PROPOSAL_ACCEPTED = {}

---@class PET_BATTLE_QUEUE_PROPOSAL_DECLINED
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_QUEUE_PROPOSAL_DECLINED)
local PET_BATTLE_QUEUE_PROPOSAL_DECLINED = {}

---@class PET_BATTLE_QUEUE_PROPOSE_MATCH
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_QUEUE_PROPOSE_MATCH)
local PET_BATTLE_QUEUE_PROPOSE_MATCH = {}

---@class PET_BATTLE_QUEUE_STATUS
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_QUEUE_STATUS)
...
---[Documentation](https://wow.gamepedia.com/PET_BATTLE_XP_CHANGED)
