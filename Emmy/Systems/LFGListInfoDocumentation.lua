...
---@class LFG_GROUP_DELISTED_LEADERSHIP_CHANGE
---@field listingName string
---@field automaticDelistTimeRemaining number
---[Documentation](https://wow.gamepedia.com/LFG_GROUP_DELISTED_LEADERSHIP_CHANGE)
local LFG_GROUP_DELISTED_LEADERSHIP_CHANGE = {}
