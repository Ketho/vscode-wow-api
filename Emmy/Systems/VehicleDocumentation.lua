...
---[Documentation](https://wow.gamepedia.com/PLAYER_GAINS_VEHICLE_DATA)
local PLAYER_GAINS_VEHICLE_DATA = {}

---@class PLAYER_LOSES_VEHICLE_DATA
---@field unitTarget string
---[Documentation](https://wow.gamepedia.com/PLAYER_LOSES_VEHICLE_DATA)
...
---[Documentation](https://wow.gamepedia.com/UNIT_ENTERED_VEHICLE)
...
---@field mayChooseExit boolean
---@field hasPitch boolean
---[Documentation](https://wow.gamepedia.com/UNIT_ENTERING_VEHICLE)
local UNIT_ENTERING_VEHICLE = {}

---@class UNIT_EXITED_VEHICLE
---@field unitTarget string
---[Documentation](https://wow.gamepedia.com/UNIT_EXITED_VEHICLE)
local UNIT_EXITED_VEHICLE = {}

---@class UNIT_EXITING_VEHICLE
---@field unitTarget string
---[Documentation](https://wow.gamepedia.com/UNIT_EXITING_VEHICLE)
local UNIT_EXITING_VEHICLE = {}

---@class VEHICLE_ANGLE_SHOW
---@field shouldShow number
---[Documentation](https://wow.gamepedia.com/VEHICLE_ANGLE_SHOW)
local VEHICLE_ANGLE_SHOW = {}

---@class VEHICLE_PASSENGERS_CHANGED
---[Documentation](https://wow.gamepedia.com/VEHICLE_PASSENGERS_CHANGED)
local VEHICLE_PASSENGERS_CHANGED = {}

---@class VEHICLE_POWER_SHOW
---@field shouldShow number
---[Documentation](https://wow.gamepedia.com/VEHICLE_POWER_SHOW)
local VEHICLE_POWER_SHOW = {}

---@class VEHICLE_UPDATE
---[Documentation](https://wow.gamepedia.com/VEHICLE_UPDATE)
