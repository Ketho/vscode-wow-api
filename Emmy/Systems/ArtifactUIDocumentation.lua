...
---[Documentation](https://wow.gamepedia.com/ARTIFACT_CLOSE)
...
---[Documentation](https://wow.gamepedia.com/ARTIFACT_ENDGAME_REFUND)
local ARTIFACT_ENDGAME_REFUND = {}

---@class ARTIFACT_RELIC_FORGE_CLOSE
---[Documentation](https://wow.gamepedia.com/ARTIFACT_RELIC_FORGE_CLOSE)
local ARTIFACT_RELIC_FORGE_CLOSE = {}

---@class ARTIFACT_RELIC_FORGE_PREVIEW_RELIC_CHANGED
---[Documentation](https://wow.gamepedia.com/ARTIFACT_RELIC_FORGE_PREVIEW_RELIC_CHANGED)
local ARTIFACT_RELIC_FORGE_PREVIEW_RELIC_CHANGED = {}

---@class ARTIFACT_RELIC_FORGE_UPDATE
---[Documentation](https://wow.gamepedia.com/ARTIFACT_RELIC_FORGE_UPDATE)
local ARTIFACT_RELIC_FORGE_UPDATE = {}

---@class ARTIFACT_RELIC_INFO_RECEIVED
---[Documentation](https://wow.gamepedia.com/ARTIFACT_RELIC_INFO_RECEIVED)
local ARTIFACT_RELIC_INFO_RECEIVED = {}

---@class ARTIFACT_RESPEC_PROMPT
---[Documentation](https://wow.gamepedia.com/ARTIFACT_RESPEC_PROMPT)
...
---@field bagOrSlotIndex number
---@field slotIndex number
---[Documentation](https://wow.gamepedia.com/ARTIFACT_TIER_CHANGED)
local ARTIFACT_TIER_CHANGED = {}

---@class ARTIFACT_UPDATE
---@field newItem boolean
---[Documentation](https://wow.gamepedia.com/ARTIFACT_UPDATE)
local ARTIFACT_UPDATE = {}

---@class ARTIFACT_XP_UPDATE
---[Documentation](https://wow.gamepedia.com/ARTIFACT_XP_UPDATE)
