...
---[Documentation](https://wow.gamepedia.com/HEIRLOOM_UPGRADE_TARGETING_CHANGED)
...
---[Documentation](https://wow.gamepedia.com/HEIRLOOMS_UPDATED)
local HEIRLOOMS_UPDATED = {}
